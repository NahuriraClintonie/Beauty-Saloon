...
<body>
    <div id="load">
		...
		<center><b><div style="margin-top:20px">For inquiries contact
			<p>Phone Number 1 | Phone Number 2 | Phone Number 3 | Phone Number 5</p>
			<p><span style="font-size:12px; color:white">put here the domain name | put here the email of the school</span>
		</p></div></b></center>
    </div>
...
<div class="box">
	...
	<div class="field" style="background:#ccffcc; padding:5px">
        <p class="label"><b>Note</b></p>
        <p><span style="color:#ff1a1a">When schools are reopened you will be required to present a <b>copy of results</b> at school before receiving an admission letter</span></p>
    </div>
</div>
<div class="field">
